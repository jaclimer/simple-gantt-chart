...
// Day first letters (more abbreviated)
Date.dayFirstLetters = new Array('S', 'M', 'T', 'W', 'T', 'F', 'S');
...
Date.prototype.yearDiff = function(date1, date2) {
    return Math.abs(date1.getYear() - date2.getYear());
};

// Returns the number of months between two dates
Date.prototype.monthDiff = function(date1, date2) {
    var months;
...
Date.prototype.numberOfDaysInMonth = function () {
    ...
    var nextMonth = tempDate.add('d', (tempDate.getDate() * -1) + 1).add('M', 1);
    return nextMonth.add('d', -1).getDate();
};
